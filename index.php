      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
           <div align='left' class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">CHECKER VENEC0</h3>
          </div>
        </div>
...
<!--            <div class="card-text" align='left'>
    ...
    <div class="col-md-3">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title" align='left'>INFORMACIONES</h4>
          <a class="heading-elements-toggle">
            <i class="la la-ellipsis-v font-medium-3"></i>
          </a>
          <div class="heading-elements">
        ...
        <div class="card-content collapse show">
          <div class="card-body">
            <span>APROBADAS:</span>&nbsp;<span id="lives_ccs" class="badge badge-success">0</span><br><br>
            ...
            <span>CARGADAS:</span>&nbsp;<span id="total_ccs" class="badge badge-dark">0</span><br>
          </div>
...
<a class="btn btn-try-builder btn-bg-gradient-x-purple-red btn-glow white" href="" target="_blank"><i class="ft-airplay"></i> Api by Elihujps</a>
